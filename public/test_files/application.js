...
(function($){
  ...
  $.fn.slides.option = {
    ...
    preloadImage: '/img/simplething/loading.gif', // string, Name and location of loading image for preloader. Default is "/img/loading.gif"
...
(function() {
  ...
  $.fn.fire = function(eventName, options) {
    options = options || {};
...
(function() {
  ...
  $(function() {
    var defaultSort, portfolioCats, portfolioItems;
    $(".time-ago").timeago();
    $(".demo-popover").each(function() {
      var demoPopover;
      demoPopover = $(this);
      return demoPopover.popover({
        html: true
      }).click(function(e) {
        return e.preventDefault();
      });
    });
    $(document).on("click", ".close-demo-popover", function(e) {
      e.preventDefault();
      return $(".demo-popover").popover("hide");
    });
    portfolioItems = $(".portfolio.items");
    portfolioCats = $(".portfolio-cats");
    if (portfolioItems.length > 0 && portfolioCats.length > 0) {
      defaultSort = Cookies.get("portfolio-sort") || "index";
      portfolioItems.bind("sort", function(e) {
        var sorter;
        if (!e.sort) {
          return;
        }
        ...
        sorter.find(".item").tsort({
          data: e.sort,
          order: "desc"
        });
        sorter.find(".item").each(function(i, el) {
          var currentContainer;
          currentContainer = portfolioItems.find(".row-fluid").eq(i / 3);
          return $(el).detach().appendTo(currentContainer);
        });
      ...
      portfolioCats.find("li").click(function(e) {
        e.preventDefault();
        return portfolioItems.fire("sort", {
          sort: $(this).data("sort")
        });
      });
    }
    if ($(".gallery").length > 0) {
      $(".gallery").slides({
        ...
        animationComplete: function(i) {
          console.log("SWAPPED");
          return $(".scroll-thumbs").scrollTo($(".scroll-thumbs .act"), {
            offset: {
              left: -50
            }
          });
    ...
    $(".fancybox").fancybox();
    return $(".close-announcement").click(function(e) {
      e.preventDefault();
      $(this).hide();
      return $(".announcement").find(".train-icon").hide().end().css({
        'min-height': "auto"
      }).slideUp();
    });
  });
